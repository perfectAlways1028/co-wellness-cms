...
const fields = [
    ...
    {
        title: Strings.txtFieldFruit,
        field: 'dailyTargetValue',
    },
    {
        title: Strings.txtFieldFruitTarget,
        field: 'dailyTarget',
    },
    {
...
class Fruit extends Component {
    ...
    onRowClick = (rowData, index) => {
        ...
        this.props.history.push(`/main/user-management/detail/${employeeId}/my-wellness-record/fruit/detail/${habitRecordID}`);
    }
            ...
            <div className="sub-filter">
                ...
                <div className="cw-row">
                    <CTextInput type='search' 
                        placeholder={Strings.txtFruitSearchPlaceholder} 
...
export default inject('habitRecordStore')(observer(Fruit));
