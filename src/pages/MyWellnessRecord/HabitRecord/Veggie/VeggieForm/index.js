...
class VeggieForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            habitRecordID: null,
    ...
    onDeleteHabitRecord = (id) => {
        ...
        .then(deleted => {
            toast(Strings.txtVeggieDeleteSuccess);
            ...
            <div className="form-container"> 
                {
                    ...
                    <CTextInput containerStyle={{width: '320px'}} 
                            ...
                            placeholder={Strings.txtFieldVeggieID} 
                            disable />
                }
                <CTextInput containerStyle={{width: '320px'}} 
                        ...
                        disable />
                <CTextInput containerStyle={{width: '320px'}} 
                        label={Strings.txtFieldVeggie} 
                        value={this.state.dailyTargetValue} 
                        placeholder={Strings.txtFieldVeggie} 
                        disable />
...
export default inject('habitRecordStore')(observer(VeggieForm));