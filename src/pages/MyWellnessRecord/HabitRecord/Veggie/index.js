...
const fields = [
    ...
    {
        title: Strings.txtFieldVeggie,
        field: 'dailyTargetValue',
    },
    {
        title: Strings.txtFieldVeggieTarget,
        field: 'dailyTarget',
    },
    {
...
class Veggie extends Component {
    ...
    onRowClick = (rowData, index) => {
        ...
        this.props.history.push(`/main/user-management/detail/${employeeId}/my-wellness-record/veggie/detail/${habitRecordID}`);
    }
            ...
            <div className="sub-filter">
                ...
                <div className="cw-row">
                    <CTextInput type='search' 
                        placeholder={Strings.txtVeggieSearchPlaceholder} 
...
export default inject('habitRecordStore')(observer(Veggie));
