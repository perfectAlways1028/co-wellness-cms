...
class WaterForm extends Component {
    ...
    onDeleteHabitRecord = (id) => {
        ...
        .then(deleted => {
            toast(Strings.txtWaterDeleteSuccess);
            ...
            <div className="form-container"> 
                {
                    ...
                    <CTextInput containerStyle={{width: '320px'}} 
                            ...
                            placeholder={Strings.txtFieldWaterID} 
                            disable />
                }
                <CTextInput containerStyle={{width: '320px'}} 
                        ...
                        disable />
                <CTextInput containerStyle={{width: '320px'}} 
                        label={Strings.txtFieldWater} 
                        value={this.state.dailyTargetValue} 
                        placeholder={Strings.txtFieldWater} 
                        disable />
...
export default inject('habitRecordStore')(observer(WaterForm));