...
class DietRecord extends Component {
    ...
    onRowClick = (rowData, index) => {
        ...
        this.props.history.push(`/main/user-management/detail/${employeeId}/my-wellness-record/diet/detail/${targetID}`);
    }
    ...
    onApplyFilter = () => {
        ...
        this.props.dietRecordStore.findDietTargetRecords(filter)
    }
    onClear = () => {
        this.setState({
            query: null,
    ...
    render () {
        const { totalCount, dietRecords, target } = this.props.dietRecordStore;
        let data = dietRecords;
        return <div className="cw-sub-wellness-container">  
            <div className="sub-header">
                <div className="sub-title">{Strings.txtDietRecord}</div>
            </div>
            {
                target &&
            ...
            <div className="sub-filter">
                ...
                <div className="cw-row">
                    <CTextInput type='search' 
                        placeholder={Strings.txtDietRecordSearchPlaceholder} 
                    ...
                    <CButton 
                        ...
                        isLoading={this.props.dietRecordStore.isLoading}
                                ...
                                return <td key={'key'+ colIndex}>
                                    {
                                        <div style={{ justifyContent: 'flex-start', alignItems: 'center', display:'flex' }}>
                                            <CStatus value={this.getStatus(rowData['dietTargetAchieved'])} 
                                                 color={this.getColorFromStatus(rowData['dietTargetAchieved'])}/>
                                        </div>
...
export default inject('dietRecordStore')(observer(DietRecord));
